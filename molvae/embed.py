...
#Example run 
python -m pdb embed.py --vocab ../data/zinc/vocab.txt --hidden 450 --model ../molvae/MPNVAE-h450-L56-d3-beta0.001/model.iter-4 --smiles-list ../../enz-pred/data/processed/dense/olea_substrates.csv --out embeddings --gpu
...
model = JTNNVAE(vocab, args.hidden_size, args.latent_size, args.depthG)
...
#standardized_mols = [Chem.RemoveHs(i) for i in input_mols] #[rdMolStandardize.ChargeParent(i) for i in input_mols]
